        ...
        <div className="mt-10 grid gap-8 md:grid-cols-[1fr_280px] lg:grid-cols-[1fr_320px] md:items-stretch">
          ...
          <Card className="border-white/10 bg-card/80 md:h-full md:flex md:flex-col">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg text-white">{t("contactPage.directContactTitle")}</CardTitle>
              <p className="mt-1 text-sm text-white/60">
                {t("contactPage.quickReply")}
              </p>
              <div className="mt-3 flex flex-wrap gap-2" role="list" aria-label={t("contactPage.availabilityAria")}>
                {trustChips.map((chip) => (
                  <span
                    key={chip}
                    role="listitem"
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-2">
                  {socialLinks.map((item) => (
                    <a
                      ...
                      aria-label={t(`contactPage.${item.nameKey}`)}
                    >
                      <SocialLinksIcons name={t(`contactPage.${item.nameKey}`)} />
                      <span>{t(`contactPage.${item.nameKey}`)}</span>
                    </a>
                  ))}
                </div>
              </div>
